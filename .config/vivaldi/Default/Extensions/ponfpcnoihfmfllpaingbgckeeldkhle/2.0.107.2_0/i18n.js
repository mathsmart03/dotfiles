...
##
*/
(function(c){function u(){c.body.classList.add("overflow-hidden");g.style.display="block";f.style.display="block";f.scrollTop=0;g.classList.add("in");setTimeout(function(){c.body.classList.add("modal-open")},50)}function v(){c.body.classList.remove("modal-open");setTimeout(function(){f.style.display="none";g.classList.add("fade");g.classList.remove("in");setTimeout(function(){g.style.display="none";c.body.classList.remove("overflow-hidden")},300)},300)}var l,p,w="am bn et fil gu kn lv ml mr sr sw ta te".split(" "),
q={ca:["color","contrast","controls","sepia","videos"],da:["loop","support","backup","sepia"],de:"autoplay backup export import loop_start playlists screenshot sepia stop videos".split(" "),el:["theme"],es:["color","sepia"],es_419:["color","sepia"],fr:["options","support","volume","stop","message"],hr:["autoplay","mini_player","save","video_player"],id:"autoplay backup gaussian_blur reset screenshot sepia stop volume".split(" "),it:"backup loop mini_player playlists reset screenshot sepia volume".split(" "),
